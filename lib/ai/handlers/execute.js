...
export async function handleExecuteAutomation(args, user, controller, encoder) {
  ...
  try {
    ...
    const { data: automation, error } = await supabase
      .from('automations')
      .select('id, is_active, required_inputs, required_connectors, name, workflow, token_cost, author_email, requires_background, activepieces_source_flow_id, activepieces_source_project_id, activepieces_trigger_type')
