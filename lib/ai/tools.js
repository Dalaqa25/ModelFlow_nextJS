...
- When the hint contains multiple fields like "MAKE=Chevrolet, MODEL=Bolt EV, YEAR=2023, PART_NAME=stop light, MAX_BUDGET=100", extract ALL of them into existing_config.
- Parse the hint for KEY=VALUE pairs and put them all in existing_config as uppercase keys.
- Example hint: "all fields provided: MAKE=Chevrolet, MODEL=Bolt EV, YEAR=2023, PART_NAME=stop light, MAX_BUDGET=100"
- Correct existing_config: {"MAKE": "Chevrolet", "MODEL": "Bolt EV", "YEAR": "2023", "PART_NAME": "stop light", "MAX_BUDGET": "100"}
...
User: "Yes, set it up" AND user already provided data like "Chevrolet, Bolt EV, 2023, stop lights"
→ {"response": "Got it! Setting up for a 2023 Chevrolet Bolt EV stop light...", "action": {"tool": "start_setup", "hint": "PREFILLED: MAKE=Chevrolet MODEL=Bolt EV YEAR=2023 PART_NAME=stop lights"}}

🚨 PREFILLED RULE: When calling start_setup and the user has already provided field values (make, model, year, part name, budget, URL, topic, etc.), ALWAYS include them in the hint as "PREFILLED: KEY=value KEY2=value2". Use UPPERCASE keys matching the required_inputs field names. This prevents the system from asking for data the user already gave.
