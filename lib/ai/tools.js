...
export const AI_TOOLS = [
  {
    ...
    function: {
      ...
      description: "Search the marketplace for AVAILABLE automations to set up. Use when user wants to FIND or DISCOVER new automations to use (e.g., 'I want to automate invoices', 'help me automate X', 'what automations do you have').",
      parameters: {
        type: "object",
        properties: {
...
- search_automations: When user wants to FIND/DISCOVER NEW automations from marketplace (e.g., "I want to automate X")
