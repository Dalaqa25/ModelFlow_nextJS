...
export const modelDB = {
  ...
  async getModelsByAuthor(email) {
    console.log('🔍 [DB] getModelsByAuthor called with email:', email);
    ...
    console.log('🔍 [DB] Found models count:', data?.length || 0);
...
export const withdrawalDB = {
  ...
  async createWithdrawalRequest(withdrawalData) {
    console.log('🗄️ [withdrawalDB] Creating withdrawal request with data:', withdrawalData);
    ...
    console.log('🗄️ [withdrawalDB] Supabase response:', { data, error });
    ...
    console.log('✅ [withdrawalDB] Withdrawal request created successfully:', data);
    return data;
  },
