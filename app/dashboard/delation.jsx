                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-2xl bg-slate-800/90 backdrop-blur-md border border-slate-700/60 px-6 pb-6 pt-5 text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-8">
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                        ...
                                        >
                                            <p className="text-sm text-slate-300">
                                                Are you sure you want to delete <span className="font-semibold text-white">"{modelName}"</span>? This action cannot be undone.
                                            </p>
                                        </motion.div>
                                    </div>
                                </div>
                                ...
                                >
                                    <button
                                        type="button"
                                        className="inline-flex w-full justify-center rounded-xl bg-gradient-to-r from-red-600 to-red-700 px-4 py-3 text-sm font-semibold text-white shadow-lg hover:from-red-700 hover:to-red-800 sm:ml-3 sm:w-auto disabled:bg-slate-600 disabled:cursor-not-allowed transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-slate-800"
